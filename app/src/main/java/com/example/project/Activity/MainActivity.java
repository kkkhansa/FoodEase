...
public class MainActivity extends AppCompatActivity {
    ...
    private void recyclerViewPopular() {
        ...
        foodList.add(new FoodDomain("Pepperoni pizza", "pop_1", "Slices pepperoni, Mozzarella cheese, Fresh oregano, Ground black pepper, Pizza sauce", 10.00));
        foodList.add(new FoodDomain("Cheese Burger", "pop_2", "Beef, Gouda cheese, Special Sauce, Lettuce, Tomato", 8.50));
